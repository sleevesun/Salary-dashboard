...
export const usePayrollStore = defineStore('payroll', () => {
  ...
  const datasets: Record<string, PayrollNode[]> = {
    '2025-06': [
      {
        id: '1', name: '游戏业务', level: 0, expanded: true,
        desc: "业务平稳。",
        ...
        children: [
          {
            id: '1-1', name: '游戏工作室群', level: 1, expanded: false,
            desc: "原光子工作室群",
          ...
          {
            id: '1-2', name: '桃花源工作室群', level: 1, expanded: false,
            desc: "原天美工作室群",
      ...
      {
        id: '2', name: '集团发展部', level: 0, expanded: true,
        desc: "原集团职能",
        ...
        children: [
          {
            id: '2-1', name: '人力资源中台', level: 1, expanded: false,
            desc: "",
    ...
    '2025-07': [
      {
        ...
        children: [
          {
            id: '1-1', name: '游戏工作室群', level: 1, expanded: false, desc: "",
          ...
          {
            id: '1-2', name: '桃花源工作室群', level: 1, expanded: false, desc: "",
      ...
      },
      {
        ...
        children: [
          {
            id: '2-1', name: '人力资源中台', level: 1, expanded: false, desc: "",
    ...
    '2025-08': [
      {
        ...
        children: [
          {
            id: '1-1', name: '游戏工作室群', level: 1, expanded: true,
            desc: "下属工作室架构调整完成。",
            ...
            children: [
              {
                id: '1-1-1', name: '青云工作室', level: 2, expanded: false,
                desc: "新项目立项",
              ...
              {
                id: '1-1-2', name: '黑羽工作室', level: 2, expanded: false,
                desc: "海外版本冲刺",
              ...
              {
                id: '1-1-3', name: '白海豚工作室', level: 2, expanded: false,
                desc: "人员优化完成",
      ...
      },
      {
        ...
        children: [
          ...
          {
            id: '2-2', name: 'AI Lab', level: 1, expanded: false,
            desc: "[NEW] 战略重点",
